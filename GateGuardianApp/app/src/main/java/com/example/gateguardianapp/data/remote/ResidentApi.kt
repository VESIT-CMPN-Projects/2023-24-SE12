...
interface ResidentApi {
    ...
    // Admin
    @GET("admin/residents")
    suspend fun getResidentsBySociety(@Header("email") email: String): Response<List<ResidentDto>>
    ...
    suspend fun saveResident(
        @Header("email") adminEmail: String,
        @Query("name") name: String,
        @Query("email") email: String
    )

    @GET("admin/securities")
    suspend fun getSecuritiesBySociety(@Header("email") email: String): Response<List<SecurityDto>>
